...
namespace MHDecora.Admin.Application
{
    public class MonstagemService : IMontagemService
    {
        ...
        public async Task<bool> Salvar(Montagem montagem, IFormFile imagem1, IFormFile imagem2, IFormFile imagem3, IFormFile imagem4)
        {
            return await _montagemRepository.Salvar(montagem, imagem1, imagem2, imagem3, imagem4);
        }
        ...
        {
            return await _montagemRepository.Editar(montagem, arquivo1, arquivo2, arquivo3, arquivo4);
        }
    }
}
